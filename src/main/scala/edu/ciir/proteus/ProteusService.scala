...
object Constants {
  val contents_map: Map[ProteusType, Seq[ProteusType]] = Map(ProteusType.Collection -> List(ProteusType.Page), ProteusType.Organization -> List(), ProteusType.Location -> List(), ProteusType.Video -> List(ProteusType.Person, ProteusType.Location, ProteusType.Organization), ProteusType.Page -> List(ProteusType.Picture, ProteusType.Video, ProteusType.Audio, ProteusType.Person, ProteusType.Organization, ProteusType.Location), ProteusType.Person -> List(), ProteusType.Picture -> List(ProteusType.Person, ProteusType.Location, ProteusType.Organization), ProteusType.Audio -> List(ProteusType.Person, ProteusType.Location, ProteusType.Organization))
  val container_map: Map[ProteusType, Seq[ProteusType]] = Map(ProteusType.Collection -> List(), ProteusType.Organization -> List(ProteusType.Page, ProteusType.Picture, ProteusType.Video, ProteusType.Audio), ProteusType.Location -> List(ProteusType.Page, ProteusType.Picture, ProteusType.Video, ProteusType.Audio), ProteusType.Video -> List(ProteusType.Page), ProteusType.Page -> List(ProteusType.Collection), ProteusType.Person -> List(ProteusType.Page, ProteusType.Picture, ProteusType.Video, ProteusType.Audio), ProteusType.Picture -> List(ProteusType.Page), ProteusType.Audio -> List(ProteusType.Page))
